...
if [[ $# -eq 0 ]]; then
  images=(cpredict-indexer:ci cpredict-paymaster:ci cpredict-permit2-relay:ci cpredict-metadata:ci cpredict-app-service:ci cpredict-web-demo:ci cpredict-public-site:ci "$postgres_image")
else
  images=("$@")
fi
